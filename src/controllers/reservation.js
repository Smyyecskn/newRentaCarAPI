  ...
  create: async (req, res) => {
    /*
            ...
            #swagger.parameters['body'] = {
                ...
                required: true,
                schema: {
                    $ref: '#/definitions/Reservation' //!fieldNameleri swaggerAutogende tanımladık ordan alabilirsin.
                }
            }
        */

    // "Admin/staf değilsen" veya "UserId göndermilmemişse" req.user'dan al:
